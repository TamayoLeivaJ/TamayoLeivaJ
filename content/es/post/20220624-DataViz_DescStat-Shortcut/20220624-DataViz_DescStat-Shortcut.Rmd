...
El *boxplot* es un tipo de visualización muy útil porque nos permite identificar en un solo gráfico los cuantiles (0,25 (Q1), 0,5 (Q2) y 0,75 (Q3)), así como los valores atípicos (*outliers*) de un conjunto de datos. El *violin plot* es otro tipo de visualización, en el que podemos observar la distribución de los datos, lo que nos permite observar más claramente la densidad.<br>
