...
knitr::opts_chunk$set(echo = FALSE, message = FALSE, warning = FALSE, fig.height=6, fig.width=6, res = 300)
library(systemfonts)
library(datapasta)
library(DataEditR)
library(tidyverse)
...
DT::datatable(head(data, n=20), fillContainer = FALSE, options = list(pageLength = 4))
```
