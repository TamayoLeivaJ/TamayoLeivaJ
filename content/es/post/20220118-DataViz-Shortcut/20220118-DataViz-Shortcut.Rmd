---
title: "De datos a la visualización en R (fácilmente)"
description: "Un atajo usando {datapasta}, {dataeditr} y {ggplot2}"
author: "Javier Tamayo-Leiva" 
date: 2022-01-20
featured_image: "/images/post/20220118-DataViz-Shortcut/20220118-DataViz-Shortcut.png"
layout: post
toc: FALSE
tags: ["DataViz", "datapasta", "dataeditr","ggplot2"]
...
<img src="/images/post/20220118-DataViz-Shortcut/datapasta.png" alt="{datapasta}" style="height: 230px; width:200px;" class="center"/>
...
<img src="/images/post/20220118-DataViz-Shortcut/datapasta_procedure.png" alt="{datapasta} procedure" class="w-40-ns mw4 center"/>
...
<img src="/images/post/20220118-DataViz-Shortcut/ggplot2.png" alt="{ggplot2}" style="height: 230px; width:200px;" class="center"/>

### Gráfico básico {#body2.1}

Lo primero que haremos es revisar el conjunto de datos de pingüinos que acabamos de cargar en R, y seleccionar las variables que representaremos en nuestra primera figura.De todas las variables, para nuestro primer gráfico seleccionaremos "bill_length_mm" (longitud del pico en milímetros) y "bill_depth_mm" (profundidad del pico en milímetros) debido a que son variables continuas.<br>

<img src="/images/post/20220118-DataViz-Shortcut/culmen_depth.png" alt="penguins" style="height: 400px; width:621px;" class="center"/>
