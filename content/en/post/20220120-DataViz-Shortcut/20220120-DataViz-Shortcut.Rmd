...
knitr::opts_chunk$set(echo = FALSE, message = FALSE, warning = FALSE, fig.height=4, fig.width=4, fig.align = "center", res = 300)
library(systemfonts)
library(datapasta)
library(DataEditR)
library(tidyverse)
...
ggplot(data = data, 
   ...
   labs(x = "Species",
        y = "Bill length (mm)",
        fill = "Species",
        title = "Penguins species in the Palmer archipelago,\nAntarctica")
```
