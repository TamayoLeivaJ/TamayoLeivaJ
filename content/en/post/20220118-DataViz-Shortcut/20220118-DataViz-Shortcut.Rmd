---
title: "From data to viz in R (easily)"
...
The first thing we will do is review the penguin data set that we just loaded into R, and select the variables that we will represent in our first figure.Of all the variables, for our first graph we will select "bill_length_mm" (bill length in millimeters) and "bill_depth_mm" (bill depth in millimeters) because they are continuous variables.<br>
